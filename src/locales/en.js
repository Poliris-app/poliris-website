export default {
  ...
  siteOverviewMockup: {
    ...
    lastUpdate: 'Last update about 5 hours ago',
    ...
    insightText: 'Your content quality score is currently limited by poor topical cluster alignment across 11 pages. To recover 10 points in health, audit these pages and revise their internal linking structure to better support your core thematic hubs.',
    critical: 'Critical',
    crawlTitle: 'Crawl & Indexation',
    crawlSub: 'Pages analyzed and indexed by Google',
    crawlDesc: "Critical indexation loss: half of your website is missing from Google's index. Immediate audit required to fix quality issues or noindex tags.",
    indexed: 'Indexed',
    notIndexed: 'Not Indexed',
    statusTitle: 'Page Status',
    statusSub: 'HTTP response distribution',
    statusDesc: 'Critical system errors: over a third of crawled pages are failing. Severe organic ranking and data loss detected; fix server response pipelines.',
