export default {
  ...
  visibility: {
    ...
    sourceIntel: {
      ...
      sourceTypes: { review: 'Review', media: 'Media', social: 'Social', retail: 'Retail', news: 'News' },
      legend: [
  ...
  sentiment: {
    ...
    perAxis: {
      ...
      hundredsLabel: 'HUNDREDS OF AI ANSWERS',
      onePerAxis: 'ONE SENTIMENT PER AXIS',
