      ...
      <div className="bp-layout">
        ...
        <main className="bp-main">
          ...
          <section className="bp-section" id="s-semantic" style={{ scrollMarginTop: '90px' }}>
            ...
            <p>Un balisage HTML front-end propre doit toujours être associé à des données structurées précises côté back-end. Il ne suffit pas d'avoir un JSON-LD générique sur une page ; il doit être mappé avec précision au format de contenu spécifique. Intégrer les <a target="_blank" rel="noopener" href="https://schema.org/docs/documents.html">standards Schema.org</a> officiels aide les moteurs de recherche à cataloguer vos concepts instantanément.</p>
